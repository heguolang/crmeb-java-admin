  ...
  <div class="divBox">
    ...
    <el-card class="box-card mt14">
      <el-table v-loading="listLoading" :data="tableData.data" size="mini" highlight-current-row>
        ...
        <el-table-column prop="voucher" label="变动消费券" min-width="120" />
        <el-table-column prop="balance" label="剩余消费券" min-width="120" />
...
<script>
import { voucherRecordListApi } from '@/api/marketing';
...
export default {
  ...
  methods: {
    ...
    getList(page) {
      ...
      voucherRecordListApi({ page: this.tableFrom.page, limit: this.tableFrom.limit }, this.tableFrom)
        .then((res) => {
